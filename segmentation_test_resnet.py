...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='/home/ljj/workspace/antigravity/snuailab_dev/work_dirs/pad_resnet/pad_resnet_v1_config.py', help='config path')
    parser.add_argument('--model_path', type=str, default='/home/ljj/workspace/antigravity/snuailab_dev/work_dirs/pad_resnet/epoch_22.pth', help='model.pt path')
