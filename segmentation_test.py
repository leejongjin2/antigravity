...
def main(args):
    maskrcnn_model = init_detector( args.configs, args.model_path, device="cuda")
    ...
    if 'mask' not in img_name:
        ...
        # Crop
        cropped_img, mask = get_bbox_and_mask(img, bbox_int, mask)
...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='/home/ljj/workspace/antigravity/test//ckpt/epoch_50.pth', help='model.pt path')
    parser.add_argument('--configs', type=str, default='/home/ljj/workspace/antigravity/test/configs/mrcnn_config_inside.py', help='config path')
    parser.add_argument('--result_path', type=str, default='/home/ljj/workspace/antigravity/test/result', help='result path')
    parser.add_argument('--input_path', type=str, default='/home/ljj/workspace/antigravity/test/sample/1.jpg', help='result path')
