...
from mask_rcnn_train import train_detector
...
def main(args):
    # Config 파일에는 model, data, resume model(이어서 학습)에 대한 내용이 포함되어 있음.
    ...
    '''
    1. opencv thread 설정
    2. Data load 부분의 worker gpu 설정
        - OMP Thread
        - setup MKL threads
    '''
    setup_multi_processes(cfg)

    # set cudnn_benchmark# 이 부분은  Default True 설정하여 학습하는 편이 좋아보임.
...
#     parser.add_argument('--model_path', type=str, default='/Users/ijongjin/workspace/antigravity/ckpt/epoch_50.pth', help='model.pt path')
#     parser.add_argument('--configs', type=str, default='/Users/ijongjin/workspace/antigravity/configs/mrcnn_config_inside.py', help='config path')
#     parser.add_argument('--result_path', type=str, default='/Users/ijongjin/workspace/antigravity/result', help='result path')
#     parser.add_argument('--input_path', type=str, default='/Users/ijongjin/workspace/anti_data/pad_sample', help='result path')
